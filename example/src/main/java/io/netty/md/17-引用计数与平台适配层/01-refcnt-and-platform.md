...
<!-- 核对记录：已对照 AbstractReferenceCounted.java 全文、RefCnt.java 全文、ResourceLeakDetector.java 全文，差异：无 -->
...
<!-- 核对记录：已对照 RefCnt.java 第38-46行，差异：无 -->
...
<!-- 核对记录：已对照 RefCnt.java AtomicRefCnt 内部类，差异：无 -->
...
<!-- 核对记录：已对照 RefCnt.java AtomicRefCnt.retain0() 方法，差异：无 -->
...
<!-- 核对记录：已对照 RefCnt.java AtomicRefCnt.release0() 方法，差异：无 -->
...
<!-- 核对记录：已对照 RefCnt.java UnsafeRefCnt/VarHandleRefCnt/AtomicRefCnt 三个内部类，差异：无 -->
...
<!-- 核对记录：已对照 AbstractReferenceCounted.java 全文，差异：补充了 setRefCnt() 方法（已修正） -->
...
<!-- 核对记录：已对照 ResourceLeakDetector.java track0()、reportLeak()、DefaultResourceLeak.dispose() 方法，差异：无 -->
...
<!-- 核对记录：已对照 ResourceLeakDetector.java track0() 方法第285-292行，差异：无 -->
...
<!-- 核对记录：已对照 ResourceLeakDetector.java DefaultResourceLeak.record0() 方法第480-510行，差异：无 -->
...
<!-- 核对记录：已对照 ResourceLeakDetector.java DefaultResourceLeak 内部类字段声明，差异：无 -->
...
<!-- 核对记录：已对照 PlatformDependent.java 第85-135行字段声明，差异：补充了中间省略字段的注释说明（已修正） -->
...
<!-- 核对记录：已对照 PlatformDependent.java initializeVarHandle() 方法第260-290行，差异：无 -->
...
<!-- 核对记录：已对照 PlatformDependent.java Mpsc 内部类第1241-1258行，差异：方法顺序已与源码对齐（newMpscQueue(maxCapacity) → newChunkedMpscQueue → newMpscQueue()，已修正） -->
...
<!-- 核对记录：已对照 PlatformDependent.java 第1290-1320行，差异：无 -->
...
<!-- 核对记录：已对照 PlatformDependent.java 静态初始化块第155-230行，差异：无 -->
